...
if (isset($_SESSION["uid"])) {
	...
	`city`, `province`, `zip`, `cardname`,`cardnumber`,`expdate`,`prod_count`,`total_amt`,`cvv`,`adate`) 
	VALUES ($order_id, '$user_id','$f_name','$email', 
    '$address', '$city', '$province', '$zip','$cardname','$cardnumberstr','$expdate','$total_count','$prod_total','$cvv','$daten')";
