    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 sidebar fixed-top">
                ...
                text-center oy-3 mb-4 b-border">Staff Panel</a>
			...
			$result = $con->query($sql);
                ...
                <!--    <li class="nav-item"><a href="AddProduct.php" class="nav-link text-white p-3 
                    ...
                    Add Products</a></li>-->
                    <li class="nav-item"><a href="admin_inquiry.php" class="nav-link text-white p-3 
                        mb-1 sidebar-link"><i class="fas fa-wrench test-light fa-lg mr-3"></i>
                    Inquiry</a></li>
                    <li class="nav-item"><a href="admin_repair.php" class="nav-link text-white p-3 
                        mb-1 sidebar-link"><i class="fas fa-wrench test-light fa-lg mr-3"></i>
                    Repair</a></li>
