                            ...
                            <tbody>
								...
								if ($result->num_rows > 0) {
									while($row = $result->fetch_assoc()) {
										echo "<tr><td>".$row["f_name"]."</td><td>".$row["email"]."</td><td> ".$row["city"]."</td><td>".$row["state"]."</td><td>".$row["adate"]."</td><td>Rs:".$row["total_amt"]."</td><td><a href='salesInfo.php?oid=".$row["order_id"]."'><i class='fa fa-edit fa-1x' style='width:25px;'></i></a>&nbsp;&nbsp;</td>
										</tr>";
										//echo $row["total_amt"];
								...
								?>
								<tr><td></td><td><strong>Total for time period</strong></td><td></td><td></td><td></td><td style="border-bottom: 5px solid black; border-top: 3px solid black;"><?php echo "Rs:".$total; ?></td><td></td></tr>
                            </tbody>
                        </table>
