				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Repair Center</h3>
						...
						<div class="row">
								...
								echo "
									<div class='col-sm-6 col-md-4 text-center'>
										...
										<a href='inquiry.php'>
												<h3>Inquiries</h3>
												<img src='img/inquiries_photo.png'>
												
										<p class='btn btn-success' role='button'>Inquiery</p>
										</a></div>
									</div>
                                     ";	
									 echo "
									<div class='col-sm-6 col-md-4 text-center'>
										<div class='thumbnail product-box'>
										<a href='repair-result.php'>
												<h3>Repairings</h3>
												<img src='img/repair_photo.png'>
												
										<p class='btn btn-success' role='button'>Repair status</p>
										</a></div>
									</div>
                                     ";	
