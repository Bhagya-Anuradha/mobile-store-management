...
if($pass==$pass2){
$passen=md5($pass);	
mysqli_query($con,"insert into admin_info (admin_id,admin_name,admin_email,admin_password,image,role) values ('','$name','$email','$passen','$pic_name','$role')") or die ("query incorrect");
}
else{
	$msg="Passwords dosent match";
}
$msg="New Staff account successfully created";
}
        ...
        <div class="row mb-5">
            ...
            <!-- <div class="col-md-9 content" > -->
  	            <div class="panel panel-default">
	                ...
	                <h1><span><i class="fa fa-tag" style="margin-left:10px;"></i></span> Add new staff </h1>
                    </div><br>
                    <?php echo $msg; ?>
                    ...
                    <div class="row align-items-center">
		                <div class="col-7">
                            ...
                            <form action="" method="post" name="form" enctype="multipart/form-data">
								...
								<p>Password</p>
                                <input class="input-lg thumbnail form-control" type="password" name="password" id="password" autofocus style="width:100%" placeholder="pass word" required>
                                <p>Confirm Password</p>
                                <input class="input-lg thumbnail form-control" type="password" name="password2" id="password2" autofocus style="width:100%" placeholder="confirm password" required>
                        ...
                        <div align="center" style="margin-top:20px;">
                            ...
                            <button type="submit" name="submit" id="submit" class="btn btn-success" style="width:150px; height:60px"> Add Staff</button>
                        </div>
                        </div>
                        </form>
                        </div>
