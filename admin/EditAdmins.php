        ...
        <div class="row mb-5">
            ...
            <!-- <div class="col-md-9 content" > -->
  	            <div class="panel panel-default">
	                ...
	                <h1><span><i class="fa fa-tag" style="margin-left:10px;"></i></span> Edit Staff </h1>
                    </div><br>
                    <?php echo $msg; ?>
...
?>
                        ...
                        <div align="center" style="margin-top:20px;">
                            ...
                            <button type="submit" name="submit" id="submit" class="btn btn-success" style="width:150px; height:60px"> Update Staff</button>
                        </div>
                        </div>
                        </form>
                        </div>
