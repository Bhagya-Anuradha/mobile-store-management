...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	if(isset($_POST["addToCart"])){
		...
		if($count > 0){
			...
			VALUES ('$p_id','$ip_add','$user_id','$cqty')";
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>RS: '.$product_price.'x'.$qty.'</h4>
												</div>
...
if (isset($_POST["updateCartItem"])) {
	...
	$msg1 = $_POST["inq"];
	$usr = $_POST["usr"];
	$msg = "INSERT into `inquiry` (`Customer`,`C_msg`) VALUES ('$usr','$msg1')";
